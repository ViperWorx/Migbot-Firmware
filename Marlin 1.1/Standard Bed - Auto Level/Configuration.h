...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define LEFT_PROBE_BED_POSITION  6 //X Left
    #define RIGHT_PROBE_BED_POSITION 187 //X Right
    #define FRONT_PROBE_BED_POSITION -70 // Y Front
    #define BACK_PROBE_BED_POSITION 95 //Y Back
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,398.269957,114.385759048} // default steps per unit for Ultimaker
...
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 80 // the duration the buzzer plays the UI feedback sound. ie Screen Click
